...
export function BooksCarousel({ books, authorName }: BooksCarouselProps) {
    ...
    return (
        <div className="relative group">
            ...
            <div
                ...
                className="flex gap-6 overflow-x-auto pb-6 pt-2 px-1 scrollbar-hide snap-x snap-mandatory"
                style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
            >
                {books.map((book) => (
                    <div key={book.id} className="min-w-[160px] w-[160px] sm:min-w-[180px] sm:w-[180px] snap-start flex-shrink-0">
                        <DiscoveredBookCard book={book} authorName={authorName} />
                    </div>
                ))}
            </div>
        </div>
